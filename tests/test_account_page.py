...
class TestAccountPage:
    ...
    def test_logout_from_right_block_after_register_new_user(
        ...
        account_page_after_logout_url = account_page.get_current_url()
        account_page_after_logout = AccountPage(browser, account_page_after_logout_url)
        ...
        login_url = account_page_after_logout.get_current_url()
