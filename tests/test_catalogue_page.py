...
class TestCataloguePage:
    ...
    def test_go_to_product_from_catalogue(self, browser, url, idx):
        ...
        product_url = page.get_current_url()
    ...
    def test_change_currency(self, browser, url, values, idx, symbol):
        ...
        page = CataloguePage(browser, url)
        page.open_url(path=URLS.CATALOGUE_PAGE)
        header_url = page.get_current_url()
        currency_page = HeaderPage(browser, header_url)
        currency_page.choose_currency(values)
        catalogue_url = currency_page.get_current_url()
        catalogue_page2 = CataloguePage(browser, catalogue_url)
    ...
    def test_go_to_others_catalogue_sections(self, browser, url, categories, value):
        ...
        new_catalogue_url = page.get_current_url()
        new_catalogue_page = CataloguePage(browser, new_catalogue_url)
